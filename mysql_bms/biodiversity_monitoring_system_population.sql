...
CREATE TABLE `population` (
  `POPULATION_ID` varchar(10) NOT NULL,
  `SCIENTIFIC_NAME` varchar(30) DEFAULT NULL,
  `CONSERVATION_STATUS` varchar(30) DEFAULT NULL,
  `POPULATION_COUNT` varchar(10) DEFAULT NULL,
  `POPULATION_TREND` varchar(15) DEFAULT NULL,
  `DATE_ASSESSED` date DEFAULT NULL,
  PRIMARY KEY (`POPULATION_ID`),
  KEY `SCIENTIFIC_NAME` (`SCIENTIFIC_NAME`),
  CONSTRAINT `population_ibfk_1` FOREIGN KEY (`SCIENTIFIC_NAME`) REFERENCES `species` (`SCIENTIFIC_NAME`) ON DELETE CASCADE
...
INSERT INTO `population` VALUES ('1','Ardeotis Nigriceps','Critically Endangered','50-249','Decreasing','2018-08-17'),('2','Rhinoceros unicornis','Vulnerable','2100-2200','Increasing','2018-12-06');
