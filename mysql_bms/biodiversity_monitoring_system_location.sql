...
CREATE TABLE `location` (
  ...
  `GEOGRAPHIC_REGION` varchar(20) DEFAULT NULL,
  `STATE` varchar(20) DEFAULT NULL,
  `PINCODE` int NOT NULL,
  PRIMARY KEY (`PINCODE`,`LOCATION_ID`),
  KEY `SCIENTIFIC_NAME` (`SCIENTIFIC_NAME`),
  CONSTRAINT `location_ibfk_1` FOREIGN KEY (`SCIENTIFIC_NAME`) REFERENCES `species` (`SCIENTIFIC_NAME`) ON DELETE CASCADE
...
INSERT INTO `location` VALUES ('1','Ardeotis Nigriceps','Thar Desert','Rajasthan',345001),('2','Rhinoceros unicornis','kanchanjuri','Assam',785609);
